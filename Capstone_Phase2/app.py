...
'''
Valid usernames for news article module
'''
USERNAME_SET = {'CNN', 'IndianExpress', 'DeccanHerald', 'BBCWorld'}
...
def summary():
    ...
    if request.method=='POST':
        ...
        if username not in USERNAME_SET:
            return "Username of the news agency is wrong!", 500

        try:
            num_of_tweets = int(num_of_tweets)
        except Exception as e:
            print("number of tweets should be an integer")
            return "number of tweets should be an integer", 500
        #print(username,num_of_tweets)
...
def review():
    ...
    if request.method=='POST':
        ...
        try:
            ...
            print('num_of_tweets should be an integer')
            return "num_of_tweets should be an integer", 500
